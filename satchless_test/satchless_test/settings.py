"""
Django settings for satchless_test project.
...
SECRET_KEY = 'lzi@ew!)-trzb!#2y+$7p)h4med75!fy$&p70bbff$lcmhryiz'
...
ROOT_URLCONF = 'satchless_test.urls'
...
WSGI_APPLICATION = 'satchless_test.wsgi.application'
